...
from ..tools.module_fitzcu import spectrum_analyze
...
class Qubit_Twotone_ef:
    ...
    def run(self, py_avg, liveplot=False):
        if liveplot:
            ...
            self.freqs = prog.get_pulse_param("qb_pulse_ef", "freq", as_array=True)
