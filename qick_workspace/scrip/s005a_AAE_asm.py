...
class PowerRabiAsmChevron(BaseExperiment):
    ...
    TITLE_PREFIX = "Qubit Power Rabi ge (ASMv2 loop)"
    ...
    def run(self, py_avg, show_final_plot=False, **kwargs):
        ...
        **kwargs
        ...
        plot_display_id = f"live-plot-aae-asm-{np.random.randint(1e9)}"
    ...
    def _post_fit(self, x_vals=None):
        ...
        print(f"\n[PowerRabiAsm] Optimal pi gain = {optimal_gain:.6f}")
        ...
        ax0.set_title("Power Rabi Chevron (ASMv2 loop)")
        ax0.legend()
